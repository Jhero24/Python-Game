...
while True:
    ...
    if current_room["name"] == "Closet":
        if len(carrying) == 6:
            print("The Tiny dog enters the Closet and with a heroic bark defeats the vaccum once and for all!")
            print("You win!")
        else:
            print("You do not have all the legendary items to defeat the evil vaccum")
            print("The tiny dog retreats from the evil vacuum and goes and hides under the bed")
            print("You lose")
        break
